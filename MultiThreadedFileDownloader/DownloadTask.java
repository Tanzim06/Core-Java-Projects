...
public class DownloadTask implements Runnable {
	...
	public DownloadTask(URL downloadUrl, long startByte, long partSize, String partName, String downloadDir,
	...
	public void run() {
		try {
			...
			try(ReadableByteChannel rbc= Channels.newChannel(connection.getInputStream())){
				...
				outputStream.getChannel().transferFrom(rbc, 0, connection.getContentLengthLong());
